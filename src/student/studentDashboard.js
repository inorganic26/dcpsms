...
export const studentDashboard = {
    app: null,
    elements: {
        container: 'student-dashboard-grid'
    },
    ...
    render() {
        ...
        if (subjects.length > 0) {
            ...
            empty.className = "col-span-full text-center text-slate-400 py-4";
            empty.textContent = "등록된 학습 과목이 없습니다.";
